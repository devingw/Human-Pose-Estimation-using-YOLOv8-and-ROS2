...
{
  new (message_memory) custom_msgs::msg::Yolov8Inference(_init);
}

void Yolov8Inference_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msgs::msg::Yolov8Inference *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Yolov8Inference_message_member_array[2] = {
  {
    ...
    offsetof(custom_msgs::msg::Yolov8Inference, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs::msg::Yolov8Inference, yolov8_inference),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Yolov8Inference_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_msgs::msg::Yolov8Inference),
...
get_message_type_support_handle<custom_msgs::msg::Yolov8Inference>()
{
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::Yolov8Inference_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msgs, msg, Yolov8Inference)() {
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::Yolov8Inference_message_type_support_handle;
}
