...
#include "custom_msgs/msg/detail/yolov8_inference__rosidl_typesupport_fastrtps_c.h"
...
#include "custom_msgs/msg/detail/inference_result__functions.h"  // yolov8_inference
...
using _Yolov8Inference__ros_msg_type = custom_msgs__msg__Yolov8Inference;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: yolov8_inference
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, custom_msgs, msg, InferenceResult
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: yolov8_inference
  {
    ...
    if (ros_message->yolov8_inference.data) {
      custom_msgs__msg__InferenceResult__Sequence__fini(&ros_message->yolov8_inference);
    }
...
size_t get_serialized_size_custom_msgs__msg__Yolov8Inference(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Yolov8Inference__ros_msg_type * ros_message = static_cast<const _Yolov8Inference__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Yolov8Inference__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__Yolov8Inference(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__msg__Yolov8Inference(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs__msg__Yolov8Inference;
    is_plain =
      (
...
static size_t _Yolov8Inference__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__msg__Yolov8Inference(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, Yolov8Inference)() {
