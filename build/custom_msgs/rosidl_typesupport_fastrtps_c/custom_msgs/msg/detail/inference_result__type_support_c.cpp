...
#include "custom_msgs/msg/detail/inference_result__rosidl_typesupport_fastrtps_c.h"
...
using _InferenceResult__ros_msg_type = custom_msgs__msg__InferenceResult;
...
static uint32_t _InferenceResult__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__InferenceResult(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs__msg__InferenceResult;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _InferenceResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__msg__InferenceResult(
