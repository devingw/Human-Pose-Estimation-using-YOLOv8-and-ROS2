...
#include "custom_msgs/msg/detail/yolov8_inference__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::Yolov8Inference & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::Yolov8Inference & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs::msg::Yolov8Inference;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::Yolov8Inference *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::Yolov8Inference *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_Yolov8Inference__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, Yolov8Inference)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_Yolov8Inference__handle;
}
