...
class InferenceResult(metaclass=Metaclass_InferenceResult):
    ...
    def box_width(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'box_width' field must be an integer in [-9223372036854775808, 9223372036854775807]"
    ...
    def box_height(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'box_height' field must be an integer in [-9223372036854775808, 9223372036854775807]"
