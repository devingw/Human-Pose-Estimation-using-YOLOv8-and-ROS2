...
bool custom_msgs__msg__detected_objects__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._detected_objects.DetectedObjects", full_classname_dest, 49) == 0);
  }
  custom_msgs__msg__DetectedObjects * ros_message = _ros_message;
  {  // object_id
...
PyObject * custom_msgs__msg__detected_objects__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._detected_objects");
