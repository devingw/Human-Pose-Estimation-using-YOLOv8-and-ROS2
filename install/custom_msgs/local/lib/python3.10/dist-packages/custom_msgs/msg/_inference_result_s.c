...
bool custom_msgs__msg__inference_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._inference_result.InferenceResult", full_classname_dest, 49) == 0);
  }
  custom_msgs__msg__InferenceResult * ros_message = _ros_message;
  {  // class_name
  ...
  {  // box_width
    ...
    assert(PyLong_Check(field));
    ros_message->box_width = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // box_height
    ...
    assert(PyLong_Check(field));
    ros_message->box_height = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // x
...
PyObject * custom_msgs__msg__inference_result__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._inference_result");
  ...
  {  // box_width
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->box_width);
    {
  ...
  {  // box_height
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->box_height);
    {
